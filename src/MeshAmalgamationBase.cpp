...
// MeshAmalgamation class function
...
void MeshAmalgamation::addVariablesToSystem(const std::string variable_name) {
...
void MeshAmalgamation::captureClusterID() {
  ...
  for (const auto &elem : _mesh.element_ptr_range()) {
    ...
    int cluster_id = elem->get_extra_integer(_extra_element_integer_index) % 12;
