...
int main(int argc, char **argv) {
    ...
    PopulateSyntheticData(mesh, equation_system, name_of_the_system, populated_variable_name, CalculateStep_x);

    EqualNeighborHeuristic demo(mesh, equation_system, name_of_the_system, populated_variable_name);
