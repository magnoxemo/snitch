...
int main(int argc, char **argv) {
    ...
    PopulateSyntheticData( equation_system, name_of_the_system, populated_std_variable_name,standard_dev);

    ThresholdHeuristics std_field( equation_system, name_of_the_system,populated_std_variable_name);
